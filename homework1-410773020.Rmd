...
```{r ans24}
c<- sum(nightowl)
d<- length(levels(twTime))
nightOwlVoteShare <-  c/d
nightOwlVoteShare
```
...
```{r ans31}
passgrade <- as.integer(grade >= 60)
earnedCredit <-passgrade * credit
earnedCredit
```
...
```{r ans32}
course <- studentID == "046S6f645" & schoolYear == "100"
credit100ChosenStudent <- sum(course * credit)
...
```{r ans33}
pass <-studentID == "046S6f645" & schoolYear == "100" & grade >= 60
earnedCredit100ChosenStudent <- sum(pass * credit)
...
```{r ans34}
Algrade <- (studentID == "046S6f645" & schoolYear == "100" & grade >= 60)*credit
Allgrade <- sum(Algrade*grade)
gpa100ChosenStudent <- Allgrade / earnedCredit100ChosenStudent
gpa100ChosenStudent
```
